...
<div class="fixed inset-0 z-50 flex items-end md:items-center justify-center">
	...
	<div
		...
		class="relative bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-700 rounded-t-2xl md:rounded-2xl shadow-2xl w-full md:w-[360px] p-5 z-10"
	>
